...
class MainWindow:
    def __init__(self):
        ...
        self.main.title("Generate-a-Password!")
        self.widgets()
        self.main.mainloop()
    ...
    def widgets(self):
        ...
        self.lengthFrame = tk.LabelFrame(self.frame, text="Size Factor")
        self.radioButton1 = tk.Radiobutton(self.lengthFrame, text="8", value=8, variable=self.length)
        ...
        self.widegtImFrame = [self.uppercase, self.specialChar, self.number]
        for item in self.widegtImFrame: item.pack(pady=5, anchor="w")
